...
Public Interface IConfig
    ...
    <OperationContract()> _
    Function GetConfigCollection(ByVal ConfigName As String) As Collections.SortedList

    <OperationContract()> _
    Sub SetConfigCollection(ByVal ConfigName As String, ByVal Configuration As Collections.SortedList)
